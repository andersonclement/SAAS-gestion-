...
@section('content')
    ...
    <div class="card" style="max-width:520px;">
        <form method="POST" action="{{ route('produits.store') }}">
            ...
            <div class="field">
                <label for="code_barres">Code-barres / QR code (optionnel)</label>
            ...
            <div class="field">
                <label for="seuil_alerte">Seuil d'alerte de stock</label>
                <input id="seuil_alerte" type="number" min="0" name="seuil_alerte" value="{{ old('seuil_alerte', 0) }}" required>
            </div>

            <button class="btn" type="submit">Créer le produit</button>
        </form>
    </div>
